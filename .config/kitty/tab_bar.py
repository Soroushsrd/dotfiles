...
opts = get_options()
active_tab_bg = as_rgb(color_as_int(opts.color15))  # Blue from theme
active_tab_fg = as_rgb(color_as_int(opts.color0))  # Black from theme
inactive_tab_bg = as_rgb(color_as_int(opts.color8))  # Gray from theme
inactive_tab_fg = as_rgb(color_as_int(opts.color7))  # White from theme
