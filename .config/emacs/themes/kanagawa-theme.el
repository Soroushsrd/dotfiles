;;; package: --- A theme inspired by the colors of the famous painting by Katsushika Hokusa -*- lexical-binding: t; no-byte-compile: t; -*-
...
(autothemer-deftheme
 ...
 (
  ...
  (tree-sitter-hl-face:type                      (:foreground fujiGray :weight 'semi-bold))
