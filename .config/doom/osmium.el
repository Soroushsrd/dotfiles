...
(let ((bg          "#1F1D2D")
  ...
  (custom-theme-set-faces
   ...
   `(font-lock-function-name-face ((t (:foreground ,blue-dim :weight bold))))
   ...
   `(font-lock-property-face ((t (:foreground ,fg))))
   ...
   `(tree-sitter-hl-face:constructor ((t (:foreground ,blue-dim :weight bold))))
   `(tree-sitter-hl-face:escape ((t (:foreground ,magenta))))
   `(tree-sitter-hl-face:function ((t (:foreground ,blue-dim))))
   `(tree-sitter-hl-face:function.builtin ((t (:foreground ,blue-dim :slant italic))))
   `(tree-sitter-hl-face:function.call ((t (:foreground ,blue-dim))))
   `(tree-sitter-hl-face:function.macro ((t (:foreground ,magenta :weight bold))))
   `(tree-sitter-hl-face:function.method ((t (:foreground ,blue-dim))))
   ...
   `(tree-sitter-hl-face:method ((t (:foreground ,blue-dim))))
   ...
   `(lsp-face-semhl-function ((t (:foreground ,blue-dim))))
   `(lsp-face-semhl-method ((t (:foreground ,blue-dim))))
   ...
   `(lsp-face-semhl-macro ((t (:foreground ,magenta :weight bold))))
   `(lsp-face-semhl-constant ((t (:foreground ,yellow))))
   `(lsp-face-semhl-property ((t (:foreground ,fg))))
   `(lsp-face-semhl-member ((t (:foreground ,fg))))
